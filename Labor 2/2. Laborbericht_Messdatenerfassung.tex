...
\begin{figure}[h]
    \centering
    \begin{minipage}[t]{0.45\textwidth} % Breite für die Tabelle
	\centering
        \vspace{0pt} % Wichtig, um eine konsistente Ausrichtung zu gewährleisten
\scalebox{0.7}{
        \begin{tabular}{|c|c|c|c|}
		\hline
	...
	\end{tabular}
        ...
        \captionof{table}{Einzelne Messungen}
    \end{minipage}%
    \hfill
    \begin{minipage}[t]{0.45\textwidth} % Breite für das Bild
	\centering
	\vspace{0pt} % Wichtig, um eine konsistente Ausrichtung zu gewährleisten
        \includegraphics[width=1.13\textwidth]{../Quellen/Labor2/Histogramm-Widerstände.png}
        \captionof{figure}{Histogramm}
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{../Quellen/Labor2/Histogramm-Widerstände_Mittelwert_Std_Abweichung.png}
