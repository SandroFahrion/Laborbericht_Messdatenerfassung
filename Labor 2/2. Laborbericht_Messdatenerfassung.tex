...
\[
C\textsubscript{x1}~\approx~ 6861~nF~~~~~~~~~~~~~
C\textsubscript{x2}~\approx~ 7575~nF
\]

\noindent Bei Addition der Toleranz, ergibt die Rechnung nur knappe 94~\% der, mit dem gemessenen Widerstand errechneten, Kapazität, also 6~\% und 476 nF weniger. Wird die Toleranz subtrahiert, ergeben sich 103~\% der Kapazität und damit 3~\% und 238~nF mehr.
...
\[
x\textsubscript{1/2}~=~4700~\Omega~\pm~(4700~\Omega~\cdot~(0.02\%~+~1~\Omega))~=~  4700~\Omega~\pm~1.94~\Omega
\]
\[
x\textsubscript{1}~=~4698.06~\Omega
\]
\[
x\textsubscript{2}~=~4701.94~\Omega
\]
